...
export default function ITSupport() {
  const services = [
    ...
    },
    {
      ...
      title: "Cybersecurity",
      description:
        "Antivirus setup, malware removal, endpoint protection, firewalls, penetration testing, and ongoing monitoring.",
    },
    {
  ...
  return (
    <Box sx={{ overflow: "hidden" }}>
      ...
      {/* CTA Section */}
      <Box sx={{ backgroundColor: "#1e40af", color: "white", py: 8, textAlign: "center" }}>
